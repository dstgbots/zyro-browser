...
# === Zyro Browser: App name rebranding ===
sed -i 's|<message name="IDS_APP_NAME">Titanium</message>|<message name="IDS_APP_NAME">Zyro Browser</message>|g' \
    chrome/browser/ui/android/strings/android_chrome_strings.grd
sed -i 's|android:label="Titanium"|android:label="Zyro Browser"|g' \
    chrome/android/java/AndroidManifest.xml
# Also cover any short_name / product_name references left by Vanadium patches
sed -i 's|<message name="IDS_SHORT_PRODUCT_NAME">Titanium</message>|<message name="IDS_SHORT_PRODUCT_NAME">Zyro Browser</message>|g' \
    chrome/browser/ui/android/strings/android_chrome_strings.grd
